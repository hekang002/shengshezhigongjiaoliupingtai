...
function renderMobileNoticeDetail() {
  ...
  return `<article class="mobile-page mobile-policy-detail mobile-notice-detail"><div class="mobile-detail-kicker"><span>${escapeHtml(notice.category)}</span><small>${escapeHtml(notice.meta)}</small></div><h1>${escapeHtml(notice.title)}</h1><p class="mobile-detail-summary">${escapeHtml(notice.summary)}</p><div class="mobile-detail-content"><section class="knowledge-detail-section"><h3>通知内容</h3><p>${escapeHtml(notice.summary)} 请相关人员结合实际工作安排及时查看并按要求落实。</p></section></div></article>`;
}
